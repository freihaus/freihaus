        ...
        <div className="">
          ...
          <div className="w-[400px] md:w-[500px] lg:w-[800px] xl:w-[1000px] p-4">
            ...
            <p>
              ...
              Nutzer der Website {`"freihaus.ch"`}. Durch die Nutzung der
            ...
            <p>
              ...
              Grafiken(ausschließlich Icons), Logos und Bilder sind Eigentum von
              Freihaus GmbH und durch das deutsche Urheberrechtsgesetz
              geschützt. Die Verwendung der Inhalte, einschließlich der
              Vervielfältigung, Modifikation, Verbreitung oder Reproduktion ohne
              vorherige schriftliche Zustimmung von Freihaus GmbH ist streng
              verboten.
            </p>
            ...
            <p>
              ...
              persönlichen Daten und dienen ausschließlich dazu, die
            ...
            <p>
              ...
              Gesetzen verantwortlich, jedoch nicht verpflichtet, übermittelte
              oder gespeicherte fremde Informationen zu überwachen.
            </p>

            <h1 className="font-bold text-xl mt-4">5. Änderungen der AGB</h1>
            <p>
              Wir behalten uns das Recht vor, diese AGB jederzeit ohne vorherige
              Ankündigung zu ändern. Die aktuelle Version der AGB ist auf
              unserer Website einsehbar.
            </p>

            <h1 className="font-bold text-xl mt-4">
              6. Einwilligung zur Datenverarbeitung durch Kontakt Formular
            </h1>
            <p>
              Mit dem Absenden des Kontakt-Formulars erklären Sie sich damit
              einverstanden, dass Ihre eingegebenen Daten (Name, E-Mail-Adresse
              und sonstige im Formular angegebene Informationen) von Freihaus
              GmbH gespeichert und verarbeitet werden, um Ihre Anfrage zu
              bearbeiten. Ihre Daten werden vertraulich behandelt und nicht ohne
            ...
            <p>
              ...
              der bis zum Widerruf erfolgten Verarbeitung Ihrer Daten. Weitere
            ...
            <p>
              ...
              undurchführbar werden, bleibt davon die Wirksamkeit der AGB im
              ...
              Bestimmungen gelten entsprechend für den Fall, dass sich die AGB
