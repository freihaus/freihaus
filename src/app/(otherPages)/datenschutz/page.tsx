      ...
      <div className="flex flex-col items-center mt-24 w-full bg-white">
        <div className="">
          ...
          <div className="w-[400px] md:w-[500px] lg:w-[800px] xl:w-[1000px] p-4">
            ...
            <p>
              Ihre Privatsphäre ist uns wichtig. Nachfolgend informieren wir Sie
              darüber, wie wir mit Ihren persönlichen Daten umgehen, die Sie
              über dieses Kontaktformular bereitstellen:
            </p>
            <p>
              Wir verwenden die von Ihnen angegebenen Informationen (Name und
              E-Mail-Adresse) ausschließlich, um auf Ihre Anfrage zu antworten.
              Wir geben Ihre Daten nicht an Dritte weiter und speichern sie nur
              solange, wie es für die Bearbeitung Ihrer Anfrage erforderlich
              ist.
            </p>
            <p>
              Mit dem Absenden dieses Formulars erklären Sie sich damit
              einverstanden, dass wir Ihre Daten gemäß unserer
              Datenschutzerklärung verwenden dürfen.
            </p>
            <p>
              Für weitere Informationen zu unseren Datenschutzpraktiken und
              Ihren Rechten kontaktieren Sie uns bitte.
            </p>
          </div>
        </div>
      </div>
