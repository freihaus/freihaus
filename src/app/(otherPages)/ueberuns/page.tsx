...
export const metadata = {
  ...
  description: "Erfahren Sie mehr über das Team hinter Freihaus, einschließlich der Gründer Nael Oesterle und Claudia Sieber Bethke, und unserer Vision für die Zukunft des Wohnens.",
  keywords: "Freihaus, Team, Nael Oesterle, Claudia Sieber Bethke, Wohnkonzepte, Nachhaltigkeit, Gemeinschaft, generationenübergreifendes Zusammenleben",
  authors: [
              ...
              <div className="w-full grid grid-cols-1 md:grid-cols-2 bg-white items-center">
                <div className="flex flex-col justify-between mt-12">
                  <div>
                    ...
                    <p className="text-2xl p-12 md:w-[400px] lg:w-[550px] xl:w-[650px]">Bei FREIHAUS GmbH verbindet sich Tradition mit Vision. Nael Oesterle, Gründer von FREIHAUS, und Claudia Sieber Bethke, seine Partnerin, bilden das kreative und ausführende Herz des Unternehmens. Gemeinsam verfolgen sie das Ziel, Wohnen und Bauen neu zu denken und zukunftsweisende Wohnkonzepte zu entwickeln, die Nachhaltigkeit, Gemeinschaft und generationenübergreifendes Zusammenleben in den Mittelpunkt stellen.</p>
                  </div>
              ...
              <div className="md:flex flex-col w-full justify-end hidden">
                ...
                <div className="flex flex-col justify-between mt-12">
                  <div>
                    ...
                    <p className="text-2xl py-12 md:w-[400px] lg:w-[550px] xl:w-[650px]">Nael bringt die Visionen zum Leben, indem er innovative Baukonzepte und Techniken anwendet, die nicht nur ökologisch nachhaltig sind, sondern auch ästhetisch und funktional überzeugen. Seine Expertise im Bereich der Baukunst ermöglicht es, alte Strukturen zu erhalten und durch Neues sinnvoll zu erweitern.</p>
                  </div>
                  <div className="w-full flex justify-end">
              ...
              <div className="w-full grid grid-cols-1 md:grid-cols-2 bg-white items-center">
                <div className="flex flex-col justify-evenly mt-12">
                  <div>
                    ...
                    <p className="text-2xl p-12 md:w-[400px] lg:w-[550px] xl:w-[650px]">Der Ansatz bei FREIHAUS ist es, Lebensräume zu schaffen, die inspirieren und Generationen verbinden. Durch die enge Zusammenarbeit von Nael und Claudia entstehen Wohnprojekte, die mehr sind als die Summe ihrer Teile - sie sind ein aktiver Beitrag zu einer lebenswerten Zukunft.</p>
                  </div>
                  <div className="w-full flex justify-end">
                    <p className="p-4 text-xl font-thin w-[400px] italic">
