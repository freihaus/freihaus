...
export const metadata: Metadata = {
  ...
  description:
    "Freihaus steht für innovative Wohnkonzepte, die das historische Erbe mit modernen Bedürfnissen verbinden. Entdecken Sie unsere maßgeschneiderten Lösungen für nachhaltige und zukunftsorientierte Lebensräume.",
  keywords: [
    "Freihaus",
