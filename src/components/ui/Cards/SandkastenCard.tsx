...
export default function SandkastenCard() {
  return (
    ...
    >
      ...
      >
        <p>
          Wir schätzen die Zusammenarbeit und den Austausch von Ideen. Der
          Sandkasten ist ein Ort der Kollaboration, an dem wir gemeinsam
          forschen und ausprobieren. Wie in einem echten Sandkasten, freuen wir
          uns immer über neue Spielgefährten und frische Ideen. Wenn Sie eine
          Idee haben, die Sie mit uns teilen möchten, laden wir Sie herzlich
          ein, Teil unseres kreativen Prozesses zu werden.
        </p>
      </motion.div>
    </motion.div>
  );
