        ...
        <div className="flex flex-col items-center justify-center w-[320px] h-[450px] border border-custom-cyan rounded-xl bg-white z-20 p-4">
            <Link href={cardHref}>
                <div className="flex flex-col items-center justify-center max-w-[300px]">
                    <h1 className="font-bold mb-4 text-neutral-600 mt-8 text-2xl text-center break-words">
                        {headText}
                    </h1>
                    <div className="text-center break-words w-[300px] mb-2">
                        {content}
                    </div>
                    ...
                    <div className="flex justify-between items-center w-full mt-6 p-4">
                        ...
                        <p className=" py-2 px-4 bg-neutral-700 text-custom-cyan border rounded-lg">Details</p>
                    </div>
                </div>
            </Link>
        </div>
